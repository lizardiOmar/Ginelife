...
.then(function (response) {
    ...
    .then(function (response) {
        ...
        function omitir(e){
            window.location.href = "C:/Users/heand/Desktop/GINELIFE/HTML/AntecedentesPersonalesQuirurgicos.html?idHistoriaClinica="+historiaClinica.idHistoriaClinica;
        }
            ...
            if(nombre){
                if(descripcion){
                    if(YYYY){
                        ...
                        axios.get('http://localhost/PHP/AntecedentesPersonalesTraumaticosController.php?idAntecedentesPersonalesTraumaticos=0&Nombre='+nombre+'&Descripcion='+descripcion+'&YYYY='+YYYY+'&idHistoriaClinica='+idHistoriaClinica)
                        .then(function (response) {
